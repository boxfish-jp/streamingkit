...
import { TaskDiff } from "../src/task_diff.js";
...
`.trim();
      ...
      expect(taskDiff1.titlePath).toEqual(newParsedNode1.titlePath);
      expect(taskDiff1.idPath).toEqual(newParsedNode1.idPath);
      ...
      expect(taskDiff2.titlePath).toEqual(newParsedNode2.titlePath);
      expect(taskDiff2.idPath).toEqual(newParsedNode2.idPath);
